 ...
 */
public class Grass implements EnchantmentDecorator {

    private static int grassEnchantmentMod = 10;
    private static String grassEnchantmentDes = ", now environmentally friendly";
